...
/**
 * Require PAYOUT_SECRET_KEY on payout create endpoints.
 * Accepts body.payoutSecret or header X-Payout-Secret.
 * Removes secret from body after verify so Joi validators stay clean.
 */
